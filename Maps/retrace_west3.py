...
RES=0.03; MS,MN=24.0,52.0; BW,BE=62.0,85.0
TILES=[]
...
LL={'Otrar':(68.30,42.85),'Ispijab':(69.75,42.30),'Talas':(71.40,42.90),'Chach':(69.28,41.31),'Almaliq':(81.30,44.05),'Shazhou':(94.66,40.14),'Kamul':(93.51,42.83),'Suzhou':(98.50,39.77),'Ganzhou':(100.45,38.93),
...
LEGS=[('Otrar','Talas'),('Chach','Otrar'),('Almaliq','Talas')]
import sys
