...
RES=0.03; MS,MN=24.0,52.0; BW,BE=84.0,123.0
TILES=[]
for f in (glob.glob('/sessions/jolly-charming-gates/mnt/outputs/work/geb3/*.tif')
         ...
         +[x for x in glob.glob('/sessions/jolly-charming-gates/mnt/outputs/work/geb/*.tif') if 'w24.246' not in x]):
...
LL={'Shazhou':(94.66,40.14),'Kamul':(93.51,42.83),'Suzhou':(98.50,39.77),'Ganzhou':(100.45,38.93),
...
LEGS=[('Kamul','Shazhou'),('Lop','Shazhou'),('Shazhou','Suzhou'),('Ganzhou','Suzhou'),('Ganzhou','Lanzhou'),
 ('Ganzhou','Ningxia'),('Etzina','Ganzhou'),('Etzina','Karakorum'),('Karakorum','Zhangye') if False else ('Etzina','Karakorum'),
 ('Kenjanfu','Lanzhou'),('Kenjanfu','Taiyuan'),('Khanbaliq','Taiyuan'),('Khanbaliq','Xanadu'),('Ningxia','Tenduc'),
 ('Tenduc','Xanadu'),('Khanbaliq','Yangzhou'),('Kinsay','Yangzhou'),('Kinsay','Zaiton')]
import sys
