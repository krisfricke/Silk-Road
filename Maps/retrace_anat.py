...
RES=0.03; MS,MN=24.0,52.0; BW,BE=30.0,42.5
TILES=[]
...
LL={'Konya':(32.50,37.87),'Sivas':(37.02,39.75),'Trebizond':(39.72,41.00),'Acre':(35.07,32.93),'Jerusalem':(35.23,31.78),'Damascus':(36.31,33.51),'Aleppo':(37.15,36.21),'Ayas':(35.79,36.77),'Shazhou':(94.66,40.14),'Kamul':(93.51,42.83),'Suzhou':(98.50,39.77),'Ganzhou':(100.45,38.93),
...
LEGS=[('Ayas','Konya'),('Sivas','Trebizond')]
import sys
